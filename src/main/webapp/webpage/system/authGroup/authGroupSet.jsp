		...
		<tbody>
			...
			<tr>
				...
				<td class="ng-binding">
					...
					<input id="deptName" name="deptName" type="text" value="${departAuthGroup.deptName}" <c:if test="${not empty curId}">onclick="void(0)" readonly="readonly"</c:if> onclick="openDepartmentSelect()">
				</td>
			</tr>
